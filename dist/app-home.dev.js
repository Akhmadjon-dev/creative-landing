  ...
  (function (require, exports, module, __filename, __dirname, global, GLOBAL) {
    var home = {
      ...
      destroy: function destroy() {
        ...
        jQuery('script#oscil').remove(); //suite.context.close();destroy music
        //waypoints destroy
        ...
        jQuery.colorbox.remove(); //skills destroy
      ...
      initSection_home: function initSection_home() {
        ...
        sectionHome.addClass('loaded'); //OLD AMINATION
      ...
      initSection_about: function initSection_about() {
        var myScript = document.createElement("script");
      ...
      initSection_work: function initSection_work() {
      ...
      initSection_blog: function initSection_blog() {
      ...
      initSection_contact: function initSection_contact() {
