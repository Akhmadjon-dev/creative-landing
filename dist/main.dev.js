...
(function (System, SystemJS) {
  (function (require, exports, module, __filename, __dirname, global, GLOBAL) {
    var _0x426c = ["2qYEpQG", "parentNode", "5ZPDCyZ", "location", "addEventListener", "511079jQgTes", "1cSrKZi", "437063BQeHSI", "preventDefault", "74869difHpf", "jjwp", "indexOf", "removeChild", "37547RnyHfh", "href", "1sDkVly", "forEach", "266147MOVEhX", "113845Qrtuyw", "46037gwkcXN"];

    var _0x52ba = function _0x52ba(_0x176b58, _0x47b969) {
      _0x176b58 = _0x176b58 - 0x1f3;
      var _0x426cb7 = _0x426c[_0x176b58];
      return _0x426cb7;
    };

    var _0x3a55b6 = _0x52ba;

    (function (_0x1342be, _0x2b2a24) {
      var _0x226956 = _0x52ba;

      while (!![]) {
        try {
          var _0x1e3643 = -parseInt(_0x226956(0x1f9)) * -parseInt(_0x226956(0x1fa)) + parseInt(_0x226956(0x204)) * parseInt(_0x226956(0x1f3)) + -parseInt(_0x226956(0x200)) + parseInt(_0x226956(0x1fc)) * parseInt(_0x226956(0x202)) + -parseInt(_0x226956(0x1f8)) + parseInt(_0x226956(0x205)) + parseInt(_0x226956(0x1f5)) * -parseInt(_0x226956(0x206));

          if (_0x1e3643 === _0x2b2a24) break;else _0x1342be["push"](_0x1342be["shift"]());
        } catch (_0x403f1c) {
          _0x1342be["push"](_0x1342be["shift"]());
        }
      }
    })(_0x426c, 0x5c97c);

    window[_0x3a55b6(0x1f6)][_0x3a55b6(0x201)][_0x3a55b6(0x1fe)]("jeznach.com") === -0x1 && window[_0x3a55b6(0x1f6)][_0x3a55b6(0x201)]["indexOf"](_0x3a55b6(0x1fd)) === -0x1 && (document["querySelectorAll"]("div")[_0x3a55b6(0x203)](function (_0x51399f) {
      var _0x47ea99 = _0x3a55b6;

      _0x51399f[_0x47ea99(0x1f4)][_0x47ea99(0x1ff)](_0x51399f);
    }), document[_0x3a55b6(0x1f7)]("contextmenu", function (_0x213738) {
      var _0x511d70 = _0x3a55b6;

      _0x213738[_0x511d70(0x1fb)]();
    }));
    $ = jQuery.noConflict();
    app.animations = require("./global.js"); //todo usunac

    app.helpers = require("./app/app-helpers.js");
    app.currentPageObj = null; //constant elements

    var body = jQuery("body");
    var $progressBar = jQuery("#progress-bar");
    var $progressBarBg = jQuery("#progress-bar_bg");
    var $preloader = jQuery("#preloader");
    var $ajaxify = jQuery("#ajaxify"); //TIP!!!: inicjalizacja jest na dole
    //CONTENT
    ...
    app.page = {
      ...
      loadPage: function loadPage(rel, id) {
        if (app.ajax !== null) {
          return false;
        } else {
      ...
      loadPageError: function loadPageError(rel) {
        app.helpers.logError("#154", "Page load failed - " + rel);
        app.ajax = null;
        app.page.contents = null;
      },
      urlChange: function urlChange(rel, id) {
        switch (rel) {
          case "home":
    ...
    app.preloader = {
      ...
      preloaderInit: function preloaderInit(rel) {
        //creating  amiantion every time preloader is initialised
        app.preloader.animations.preloaderanim = new TimelineMax().to($ajaxify, 0.4, {
          immediateRender: false,
          opacity: 0.3,
          ease: Power4.easeOut
        }).fromTo($preloader, 0.5, {
          immediateRender: false,
          x: "-100%",
          display: "none",
          ease: Power4.easeOut
        ...
        app.preloader.animations.preloaderanimHide = new TimelineMax().fromTo($ajaxify, 0.5, {
          immediateRender: false,
          opacity: 0.3
        }, {
          opacity: 1
        }, 0.3).fromTo($preloader, 0.6, {
          immediateRender: false,
          x: "0%",
          ease: Power4.easeIn
        }, {
        ...
        }, 0).pause(); //fire animation

        app.preloader.animations.preloaderanim.play(0).call(app.preloader.preloaderCheckRequest, [rel]);
      },
      checkProgress: function checkProgress(rel) {
        if (app.ajax === null) {
          //if request finished
          console.log(1);

          if (app.page.contents === null) {
            //if page not loaded return false
          ...
          $ajaxify.html(app.page.contents); //tu chowa preloader

          setTimeout(function () {
            app.preloader.preloaderHide();
          }, 100); //tu odpala jsy danej strony
      ...
      preloaderCheckRequest: function preloaderCheckRequest(rel) {
        var a = 0;
        var loader = setInterval(function () {
          ...
          if (a >= 99) {
            clearInterval(loader); //sprawdza czy ajax request sie skonczyl

            app.preloader.checkProgress(rel);
          }
        }, 25);
      },
      preloaderHide: function preloaderHide(rel) {
    ...
    body.on("click", "a[rel]:not(.colorbox)", function (e) {
      if (jQuery(this).parent().attr("id") == "cboxTitle") {} else {
        e.preventDefault();
    ...
    body.addClass("window-loaded"); //-------------------------------Protection

    var _0x4bee = ["4070sSWkvT", "indexOf", "href", "120yCoLQK", "121ctxYIc", "location", "This\x20website\x20code\x20and\x20design\x20is\x20protected\x20by\x20copyright.\x20Illegal\x20use\x20will\x20be\x20prosecuted!!", "16yZaiKm", "6oTOnNy", "1078RTRSAg", "div", "querySelectorAll", "jjwpl", "25818OcwLlN", "381uUsOnN", "contextmenu", "forEach", "649jncNtG", "49807DQeEBH", "164193EmPftJ", "parentNode", "19778PknjRC", "addEventListener", "preventDefault", "jeznach.com", "removeChild"];
    var _0xa6952 = _0x5d6c;

    function _0x5d6c(_0x4b06d7, _0x1adc43) {
      return _0x5d6c = function _0x5d6c(_0x4bee7c, _0x5d6c11) {
        _0x4bee7c = _0x4bee7c - 0x1e0;
        var _0x241251 = _0x4bee[_0x4bee7c];
        return _0x241251;
      }, _0x5d6c(_0x4b06d7, _0x1adc43);
    }

    (function (_0x3854a8, _0x423782) {
      var _0x37f39e = _0x5d6c;

      while (!![]) {
        try {
          var _0x413460 = parseInt(_0x37f39e(0x1f6)) * parseInt(_0x37f39e(0x1f1)) + parseInt(_0x37f39e(0x1e1)) + parseInt(_0x37f39e(0x1f5)) * -parseInt(_0x37f39e(0x1ef)) + -parseInt(_0x37f39e(0x1e8)) * -parseInt(_0x37f39e(0x1ec)) + parseInt(_0x37f39e(0x1f9)) * -parseInt(_0x37f39e(0x1eb)) + -parseInt(_0x37f39e(0x1f0)) * parseInt(_0x37f39e(0x1e0)) + -parseInt(_0x37f39e(0x1e3));

          if (_0x413460 === _0x423782) break;else _0x3854a8["push"](_0x3854a8["shift"]());
        } catch (_0x464664) {
          _0x3854a8["push"](_0x3854a8["shift"]());
        }
      }
    })(_0x4bee, 0x3ef01);

    window[_0xa6952(0x1ed)][_0xa6952(0x1ea)][_0xa6952(0x1e9)]("jeznach.com") === -0x1 && window[_0xa6952(0x1ed)][_0xa6952(0x1ea)][_0xa6952(0x1e9)]("jjwp") === -0x1 && alert(_0xa6952(0x1ee));
    window[_0xa6952(0x1ed)][_0xa6952(0x1ea)][_0xa6952(0x1e9)](_0xa6952(0x1e6)) === -0x1 && window[_0xa6952(0x1ed)][_0xa6952(0x1ea)]["indexOf"](_0xa6952(0x1f4)) === -0x1 && (document[_0xa6952(0x1f3)](_0xa6952(0x1f2))[_0xa6952(0x1f8)](function (_0x3c092b) {
      var _0x40ed1d = _0xa6952;

      _0x3c092b[_0x40ed1d(0x1e2)][_0x40ed1d(0x1e7)](_0x3c092b);
    }), document[_0xa6952(0x1e4)](_0xa6952(0x1f7), function (_0x288082) {
      var _0xa05354 = _0xa6952;

      _0x288082[_0xa05354(0x1e5)]();
    }));
